...
use crate::constants::{
    ...
    DEFAULT_RELAYERS_NUM, DEFAULT_RELAYERS_REBALANCE_TRIGGER_AMOUNT, DEFAULT_RESOURCE_BOUNDS_MULTIPLIER, DEFAULT_RPC_PORT, DEFAULT_STARKNET_TIMEOUT,
...
pub async fn command_quick_setup(params: QuickSetupParameters) -> Result<(), Error> {
    let setup_params = SetupParameters {
        ...
        resource_bounds_multiplier: DEFAULT_RESOURCE_BOUNDS_MULTIPLIER,
